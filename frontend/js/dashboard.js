...
class DashboardManager {
        ...
        if (this.transactions.length === 0) {
            ...
            transactionList.innerHTML = `
                <div class="empty-state">
                    ...
                    <button class="btn btn-primary btn-sm" onclick="dashboard.openAddTransactionModal()">
    ...
    async handleAddTransaction(e) {
        ...
        // Validation
        if (!transactionData.name || !transactionData.amount || !transactionData.type || !transactionData.category) {
